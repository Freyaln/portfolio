...
/** @typedef IListProps
 * @prop { SkillDetail[] } optionsSkills Used in the 'about' component
 * @prop { InfosDatas[] } optionsInfos Used in the 'contacts' component
 * @prop { string } classname The className of the list
 * @prop { JSX.Element | JSX.Element[] } children
 * @prop { DataType } type Enum 'Email | Phone | Location'
 */
