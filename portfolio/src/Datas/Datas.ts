...
export const projectsImageList: ImageListDatas[] = [
    {
        ...
        about:
            'Kiril and I know each other for a long time... We eventually talked about doing a project together and decided to give it a go. We wanted a project that could be displayed on our own portfolio and that it needed to be functionnal. \n\n' +
        ...
        description: [
            'We decided to experiment the UX brainstorming part because this is not always (may I dare say never ?) our job  as front-end developers. \n' +
    ...
    },
    {
        ...
        about:
            'We are in February, two or three weeks prior my internship and I feel completely lost. \n' +
        ...
        description: [
            'The hardest part was definitely the dynamic search, how many hours did I spent thinking and experimenting or searching the internets in order to find a way to do it and what joy did I felt when I finally did it ! ',
    ...
    },
    {
        ...
        about:
            'I started this website when I still was in Becode and the goal was to build it in reactjs with tons of MaterialUI components. At the time it felt like a enormous cliff to climb on and with my internship approaching I dropped the project.\n\n' +
        ...
        description: [
            'The most fun part was this one, building an ImageGrid like component in the MaterialUI style but from scratch. I though that I would bang my head in the wall multiple times but all in all, juste once. Juste once to realise that I should go for a grid layout.',
